...
namespace Editor
{
    ...
    APIWrapper815* APIWrapper815::m_pInstance = NULL;
    ...
    int APIWrapper::MaintainAttachmentsGeo(DataFeature* feature, OPERATION_TYPE type)
    {
        ...
        int attachmentsIndex = fieldDefines->GetColumnIndex(Attachments_Str);
                ...
                for (int i = 0; i< contentValue.Size(); ++i)
                {
                    ...
                    if(subValue.HasMember("geo") && !subValue["geo"].IsNull())
                    {
                           ...
                           &&geoValue.HasMember("coordinates"))
                        {
                            ...
                            {
                                std::string style = "";
                                if(subValue.HasMember("style")
                                   && subValue["style"].IsString()
                                   && !subValue["style"].IsNull())
                                {
                                    style = subValue["style"].GetString();
                                }
                            ...
                            else if (strcmp(Tools::ToUpper(const_cast<std::string&>(LineStringStr)).c_str(),Tools::ToUpper(strType).c_str())==0)
                            {
                                ...
                                std::string strWkt = DataTransfor::coordinates2Wkt(coordinates, EditorGeometry::wkbLineString);
    ...
    {
        Logger::LogD("Editor: InsertPoi failed: function not implemented");
        Logger::LogO("Editor: InsertPoi failed: function not implemented");
        return -1;
    }

    int APIWrapper::UpdatePoi(const std::string& poi, const std::string& userId, const std::string& projectId)
    {
        Logger::LogD("Editor: UpdatePoi failed: function not implemented");
        Logger::LogO("Editor: UpdatePoi failed: function not implemented");
        return -1;
    }

    int APIWrapper::DeletePoi(int rowId, const std::string& userId, const std::string& projectId)
    {
        Logger::LogD("Editor: DeletePoi failed: function not implemented");
        Logger::LogO("Editor: DeletePoi failed: function not implemented");
        return -1;
    }
    ...
    {
        Logger::LogD("Editor: UpdatePois failed: function not implemented");
        Logger::LogO("Editor: UpdatePois failed: function not implemented");
        return -1;
    }
    ...
    std::vector<std::string> APIWrapper::SnapPoint(const std::string& box, const std::string& point)
    {
        ...
        Logger::LogD("Editor: SnapPoint failed: function not implemented");
        Logger::LogO("Editor: SnapPoint failed: function not implemented");
        return ret;
    }
    ...
    std::vector<DataFeature*> APIWrapper::SelectPois(const std::string& box)
    {
        ...
        Logger::LogD("Editor: SelectPois failed: function not implemented");
        Logger::LogO("Editor: SelectPois failed: function not implemented");
    ...
    {
        Logger::LogD("Editor: GetTotalPoiByFid failed: function not implemented");
        Logger::LogO("Editor: GetTotalPoiByFid failed: function not implemented");
    ...
    int APIWrapper::GetCountByWhere(const std::string& strTable, const std::string& strWhere)
    {
        int count = 0;
        int countIndex = 0;
        std::string strSql = "";
        if (""==strTable) return count;
        try
        {
            Editor::DataManager* dataManager = Editor::DataManager::getInstance();
            std::string dataPath= dataManager->getFileSystem()->GetCoreMapDataPath();
            if(strcmp(dataPath.c_str(),"") == 0)
            {
                Logger::LogD("Editor: GetCountByWhere failed, Data Path Empty");
                Logger::LogO("Editor: GetCountByWhere failed, Data Path Empty");
                return count;
            }
            Editor::CoreMapDataSource* dataSource = dynamic_cast<Editor::CoreMapDataSource*>(dataManager->getDataSource(DATASOURCE_COREMAP));
            if(NULL==dataSource)
            ...
            if(feature != NULL)
            {
                count = feature->GetAsInteger(countIndex);
            }
            else
            {
                Logger::LogD("Editor: GetCountByWhere sql[%s]",strSql.c_str());
                Logger::LogO("Editor: GetCountByWhere sql[%s]",strSql.c_str());
            }
        ...
        {
            Logger::LogD("Editor: GetCountByWhere failed");
            Logger::LogO("Editor: GetCountByWhere failed");
            return count;
        }
    }
    ...
    std::vector<std::string> APIWrapper::GetProjectInfo(const std::string& sToken)
	{
        ...
        Logger::LogD("Editor: GetProjectInfo failed: function not implemented");
        Logger::LogO("Editor: GetProjectInfo failed: function not implemented");
	...
	std::vector<std::string> APIWrapper::GetProjectDetails(const std::string& sToken, const std::string& sProjectId)
	{
        ...
        Logger::LogD("Editor: GetProjectDetails failed: function not implemented");
        Logger::LogO("Editor: GetProjectDetails failed: function not implemented");
    ...
    std::vector<std::string> APIWrapper::GetTaskDetails(const std::string& sToken, const std::string& sProjectId)
	{
        ...
        Logger::LogD("Editor: GetTaskDetails failed: function not implemented");
        Logger::LogO("Editor: GetTaskDetails failed: function not implemented");
     ...
     *  插入情报数据
     *
     *  @param infosJson json字符串
     *
     *  @return 是否成功
     */
    int APIWrapper::InsertInfos(const std::string &infosJson)
    {
        Logger::LogD("Editor: InsertInfos failed: function not implemented");
        Logger::LogO("Editor: InsertInfos failed: function not implemented");
    ...
    {
        Logger::LogD("Editor: UpdateInfo failed: function not implemented");
        Logger::LogO("Editor: UpdateInfo failed: function not implemented");
        
        return -1;
    }
    
    //删除情报数据
    int APIWrapper::DeleteInfo(const std::string& globalid)
    {
        Logger::LogD("Editor: DeleteInfo failed: function not implemented");
        Logger::LogO("Editor: DeleteInfo failed: function not implemented");
    ...
    int APIWrapper::PoiStatistics(const std::string& tableName, std::vector<std::string>& results)
    {
        ...
        sprintf(buf,"SELECT count(*), %s, substr(%s,0,%d) as mydate FROM %s WHERE %s!=0 and length(%s)>=%d group by %s,mydate order by mydate asc", Poi_lifecycle.c_str(), Poi_t_operateDate.c_str(), int(DATE_FORM0.size()+1),tableName.c_str(), Poi_lifecycle.c_str(), Poi_t_operateDate.c_str(), int(DATE_FORM0.size()+1), Poi_lifecycle.c_str());
        std::string sql = buf;
    ...
    int APIWrapper::TrackStatistics(const std::string& userId, std::vector<std::string>& results)
    {
        std::vector<std::string> result;
        ...
        char buf[256];
        sprintf(buf,"SELECT count(*), substr(%s,0,%d) as mydate, GeodesicLength(%s) as trackLength FROM %s WHERE length(%s)>=%d and %s=%s and %s=%d group by mydate order by mydate asc", track_segment_StartTimeStr.c_str(), int(DATE_FORM0.size()+1),track_segment_GeometryStr.c_str(), track_segmentTableName.c_str(), track_segment_StartTimeStr.c_str(), int(DATE_FORM0.size()+1), track_segment_UserIdStr.c_str(), userId.c_str(),track_segment_LODStr.c_str(), MAX_LOD);
        
        std::string sql = buf;
        std::vector<Editor::DataFeature*> features = dataFunctor->QueryFeaturesBySql(track_segmentTableName, sql);
        Logger::LogD("APIWrapper::TrackStatistics sql [%s]", sql.c_str());
        Logger::LogO("APIWrapper::TrackStatistics sql [%s]", sql.c_str());
        
        int countIndex = 0;
        int dateIndex = 1;
        int trackLengthIndex = 2;
        ...
        for(int i = 0 ; i<features.size(); i++)
        {
            ...
            document.AddMember("count",feature->GetAsInteger(countIndex),allocator);
            
            std::string date = feature->GetAsString(dateIndex);
            rapidjson::Value each_json_value(kStringType);
            each_json_value.SetString(date.c_str(), date.size(),allocator);
            document.AddMember("date",each_json_value,allocator);
            
            document.AddMember("trackLength",feature->GetAsDouble(trackLengthIndex),allocator);
            
            rapidjson::Value each_json_value2(kStringType);
            each_json_value2.SetString(unitName.c_str(), unitName.size(),allocator);
            document.AddMember("unit",each_json_value2,allocator);
    ...
    int APIWrapper::DeleteTrack(const std::string& userId, const std::string& date)
    {
        string dataPath = m_pCoreDataSource->GetDataSourcePath();
        
        if (""==dataPath)
        {
            Logger::LogD("APIWrapper::DeleteTrack failed, DataSource Path is emtry");
            Logger::LogO("APIWrapper::DeleteTrack failed, layer is null, maybe datasource is not open");
            return -1;
            
        }
        m_pCoreDataSource->Open(dataPath);
        
        std::map<DATALAYER_TYPE, Editor_TrackStatisticsFieldsName> layerType2fieldsNmae;
        Editor_TrackStatisticsFieldsName tag;
        tag.userIdFieldNmae = track_collection_UserIdStr;
        tag.datetimeFieldNmae = track_collection_RecordTimeStr;
        layerType2fieldsNmae.insert(std::make_pair(DATALAYER_TRACKPOINT, tag));
        tag.userIdFieldNmae = track_segment_UserIdStr;
        tag.datetimeFieldNmae = track_segment_StartTimeStr;
        layerType2fieldsNmae.insert(std::make_pair(DATALAYER_TRACKSEGMENT, tag));
        
        std::map<DATALAYER_TYPE, Editor_TrackStatisticsFieldsName>::iterator itor = layerType2fieldsNmae.begin();
        
        while (itor!=layerType2fieldsNmae.end())
        {
            DATALAYER_TYPE layertype = itor->first;
            Editor::DataLayer* layer = m_pCoreDataSource->GetLayerByType(layertype);
            if(NULL == layer)
            {
                Logger::LogD("APIWrapper::DeleteTrack failed, layer is null, maybe datasource is not open");
                Logger::LogO("APIWrapper::DeleteTrack failed, layer is null, maybe datasource is not open");
                m_pCoreDataSource->Close(dataPath);
                return -1;
            }
            ...
            sprintf(buf, "select *, substr(%s,0,%d) as date from %s where length(%s)>=%d and %s=%s and date='%s';", itor->second.datetimeFieldNmae.c_str(), int(DATE_FORM0.size()+1), layer->GetTableName().c_str(), itor->second.datetimeFieldNmae.c_str(), int(DATE_FORM0.size()+1), itor->second.userIdFieldNmae.c_str(), userId.c_str(), date.c_str());
            
            layer->ResetReadingBySQL(sql);
            
            Logger::LogD("APIWrapper::DeleteTrack sql[%s]",sql.c_str());
            Logger::LogO("APIWrapper::DeleteTrack sql[%s]",sql.c_str());
            
            DataFeature* pDataFeature = layer->GetNextFeature();
            while (pDataFeature)
            {
                layer->DeleteFeature(pDataFeature);
                DataFeatureFactory::getDefaultInstance()->DestroyFeature(pDataFeature);
                pDataFeature = layer->GetNextFeature();
            }
        }
        m_pCoreDataSource->Close(dataPath);
        return 0;
    ...
    int APIWrapper::SyncTrackData2Server(const std::string sToken,
    ...
    //8.15
    //APIWrapper815::APIWrapper815(){}
    
    APIWrapper815* APIWrapper815::getInstance()
    {
        if(NULL == m_pInstance)
        {
            m_pInstance = new  APIWrapper815();
        }
        
        return m_pInstance;
    }

    int APIWrapper815::InsertPoi(const std::string& poi, const std::string& userId, const std::string& projectId)
    {
        try{
            rapidjson::Document doc;
            ...
            index = fd->GetColumnIndex(Poi_t_operateDate);
            if(index != -1)
            {
    ...
    int APIWrapper815::UpdatePoi(const std::string& poi, const std::string& userId, const std::string& projectId)
    {
        try{
            rapidjson::Document doc;
    ...
    int APIWrapper815::DeletePoi(int rowId, const std::string& userId, const std::string& projectId)
    {
        try{
            std::string dataPath= m_pDataManager->getFileSystem()->GetCoreMapDataPath();
    ...
    int APIWrapper815::UpdatePois(const std::list<std::string> & pois, const std::string& userId, const std::string& projectId, std::list<int> & failIndexs, ProgressEventer* progress)
    {
    ...
    std::vector<std::string> APIWrapper815::SnapPoint(const std::string& box, const std::string& point)
    {
        std::vector<std::string> result;
    ...
    std::vector<DataFeature*> APIWrapper815::SelectPois(const std::string& box)
    {
        std::vector<DataFeature*> pois;
    ...
    std::string APIWrapper815::GetTotalPoiByFid(const std::string& fid)
    {
        std::string dataPath= m_pDataManager->getFileSystem()->GetCoreMapDataPath();
    ...
    std::vector<std::string> APIWrapper815::SelectMetaData(const std::string& sTable, std::string condition, int type)
    {
    ...
    std::vector<std::string> APIWrapper815::GetProjectInfo(const std::string& sToken)
    {
        std::vector<std::string> vResult;
    ...
    std::vector<std::string> APIWrapper815::GetProjectDetails(const std::string& sToken, const std::string& sProjectId)
    {
        Editor::DataManager* pDataManager = Editor::DataManager::getInstance();
    ...
    std::vector<std::string> APIWrapper815::GetTaskDetails(const std::string& sToken, const std::string& sProjectId)
    {
        std::vector<std::string> vResult;
     ...
     *  @return 是否成功
     */
    int APIWrapper815::InsertInfos(const std::string &infosJson)
    {
        std::string dataPath= m_pDataManager->getFileSystem()->GetCoreMapDataPath();
        
        if(strcmp(dataPath.c_str(),"") == 0)
        {
            Logger::LogD("Editor: InsertInfo failed, Data Path Empty");
            Logger::LogO("Editor: InsertInfo failed, Data Path Empty");
            return -1;
        }
        ...
        try{
            DataLayer* layer = m_pCoreDataSource->GetLayerByType(DATALAYER_INFOR);
            
            const DataFeatureFactory* factory = DataFeatureFactory::getDefaultInstance();
            
            DataFeature* Infofeature = factory->CreateFeature(layer);
            
            rapidjson::Document doc;
            
            doc.Parse<0>(infosJson.c_str());
            
            if(doc.HasParseError())
            {
                Logger::LogD("Editor: InsertInfo failed, invalid json :[%s]",infosJson.c_str());
                Logger::LogO("Editor: InsertInfo failed, invalid json :[%s]",infosJson.c_str());
                return -1;
            }
            ...
            jsonObject.SetJsonString(infosJson);
            
            Infofeature->SetTotalPart(jsonObject);
            
            std::string globalId = DataTransfor::GetInfoGlobalId(doc);
            
            std::string displayStyle = DataTransfor::GetInfoDisplayStyle(doc);
            
            FieldDefines* fd= Infofeature->GetFieldDefines();
            
            int index = fd->GetColumnIndex(Info_globalId);
            
            if(index !=-1)
            {
                Infofeature->SetAsString(index, globalId);
            }
            
            index = fd->GetColumnIndex(Info_displaystyle);
            
            if(index !=-1)
            {
                Infofeature->SetAsString(index, displayStyle);
            }
            
            int result = layer->InsertFeature(Infofeature);
            
            if(result == -1)
            {
                DataFeatureFactory::getDefaultInstance()->DestroyFeature(Infofeature);
            ...
            Logger::LogD("Editor: InsertInfo failed In APIWrapper");
            Logger::LogO("Editor: InsertInfo failed In APIWrapper");
            return -1;
        }
        
    }
    
    int APIWrapper815::UpdateInfo(const std::string& info)
    {
        try{
            std::string dataPath= m_pDataManager->getFileSystem()->GetCoreMapDataPath();
            ...
            if(doc.HasParseError())
            {
                Logger::LogD("Editor: UpdateInfo failed, invalid json :[%s]",info.c_str());
                Logger::LogO("Editor: UpdateInfo failed, invalid json :[%s]",info.c_str());
                return -1;
            }
            ...
            FieldDefines* fd= featureInfo->GetFieldDefines();
            
            int index = fd->GetColumnIndex(Info_displaystyle);
            
            if(index !=-1)
            {
                featureInfo->SetAsString(index, displayStyle);
            }
    ...
    //删除情报数据
    int APIWrapper815::DeleteInfo(const std::string& globalid)
    {
        try{
            int result = 0;
            std::string dataPath= m_pDataManager->getFileSystem()->GetCoreMapDataPath();
            ...
            Logger::LogD("Editor: DeleteInfo openlayer finished");
            Logger::LogO("Editor: DeleteInfo openlayer finished");
            
            std::string table_name_string = layer->GetTableName();
            
            std::string sql ="SELECT * FROM "+ table_name_string + " WHERE globalld = '"+ globalid +"'";
            
            layer->ResetReadingBySQL(sql);
            
            Logger::LogD("Editor: Deleteinfo sql:[%s]",sql.c_str());
            Logger::LogO("Editor: Deleteinfo sql:[%s]",sql.c_str());
            
            DataFeature* feature = layer->GetNextFeature();
            
            if(feature == NULL)
            {
                Logger::LogD("Editor: DeleteInfos failed, infos not found, globalld: [%s]", globalid.c_str());
                Logger::LogO("Editor: DeleteInfos failed, infos not found, globalld: [%s]", globalid.c_str());
                return 0;
            }
    ...
    std::string	APIWrapper815::GetEditHistroyByFid(const std::string& fid)
    {
    ...
    int APIWrapper815::SyncTrackData2Server(const std::string sToken,
                                         const std::string sUserID,
                                         const std::string sProjectID,
                                         const Editor::ProgressEventer* pregress)
    {
        tagSyncTrackPara syncpara;
        syncpara.sToken=sToken;
        syncpara.sUserID=sUserID;
        syncpara.sProjectID=sProjectID;
        syncpara.pregress = const_cast<Editor::ProgressEventer*>(pregress);
        TrackJob job;
        int ret = job.SyncTrackData2Server(syncpara);
        return ret;
    }
    
    int APIWrapper815::DeletePoiAndInfoByRegion(const std::string& projectId, const std::string& region)
    {
        DataFunctor* dataFunctor = Editor::DataManager::getInstance()->getDataFunctor();
        ...
        if(box.is_empty())
        {
            Logger::LogD("Editor::DeletePoiAndInfoByRegion: input region is invalid");
            Logger::LogO("Editor::DeletePoiAndInfoByRegion: input region is invalid");
        ...
        std::string sql ="SELECT rowid FROM "+ PoiTableName + " WHERE project= '"+projectId+"' AND ROWID IN (SELECT ROWID FROM SpatialIndex WHERE f_table_name = '" + PoiTableName +"' AND search_frame = BuildMbr("+xmin+","+ymin+","+xmax+","+ymax+"))";
        
        std::vector<Editor::DataFeature*> poiFeatures = dataFunctor->QueryFeaturesBySql(PoiTableName.c_str(), sql);
        
        std::vector<std::string> poiRowIds;
        
        for(int i =0;i<poiFeatures.size();i++)
        {
            if(poiFeatures.at(i) == NULL)
            {
                continue;
            }
            int rowID = poiFeatures.at(i)->GetRowId();
            
            poiRowIds.push_back(Tools::NumberToString(rowID));
            
            Editor::DataFeatureFactory::getDefaultInstance()->DestroyFeature(poiFeatures.at(i));
        }
        
        int ret = dataFunctor->DeleteFeatures(PoiTableName, poiRowIds);
        
        if(ret !=0)
        {
            Logger::LogD("Editor::DeletePoiAndInfoByRegion delete poi failed");
            Logger::LogO("Editor::DeletePoiAndInfoByRegion delete poi failed");
            
            return -1;
        }
        
        sql ="SELECT rowid FROM "+ InfoTableName + " WHERE h_projectId= '"+projectId+"' AND ROWID IN (SELECT ROWID FROM SpatialIndex WHERE f_table_name = '" + InfoTableName +"' AND search_frame = BuildMbr("+xmin+","+ymin+","+xmax+","+ymax+"))";
        
        std::vector<Editor::DataFeature*> infoFeatures = dataFunctor->QueryFeaturesBySql(InfoTableName.c_str(), sql);
        
        std::vector<std::string> infoRowIds;
        
        for(int i =0;i<infoFeatures.size();i++)
        {
            if(infoFeatures.at(i) == NULL)
            {
                continue;
            }
            
            int rowID = infoFeatures.at(i)->GetRowId();
            
            infoRowIds.push_back(Tools::NumberToString(rowID));
            
            Editor::DataFeatureFactory::getDefaultInstance()->DestroyFeature(infoFeatures.at(i));
        }
        
        ret = dataFunctor->DeleteFeatures(InfoTableName, infoRowIds);
        
        if(ret !=0)
        {
            Logger::LogD("Editor::DeletePoiAndInfoByRegion delete info failed");
            Logger::LogO("Editor::DeletePoiAndInfoByRegion delete info failed");
        }
