...
const std::string DataServerAddress = "192.168.4.188:8000";

#ifdef FSNavinfoCom
const std::string _815DataServerAddressHead = "fs.navinfo.com";
#else
const std::string _815DataServerAddressHead = "192.168.4.189";
#endif
...
const std::string DATETIME_FORM0="YYYYMMDDHHMMSS";
const std::string DATE_FORM0="YYYYMMDD";

//trackdata2server data form:
const std::string trackzipfilename_head="track";
const std::string trackdata2server_idStr="id";
const std::string trackdata2server_user_idStr="user_id";
const std::string trackdata2server_track_dateStr="track_date";
const std::string trackdata2server_user_trackStr="user_track";
...
const std::string Info_displaystyle = "display_style";
...
const std::string Poi_srcInformation = "srcInformation";
