...
namespace Editor
{
	EditorGeometry::Box2D Grid::GridToLocation(std::string gridId)
	{
        ...
        int m2 = std::atoi(gridId.substr(1, 2).c_str());
        int m3 = std::atoi(gridId.substr(2, 3).c_str());
        int m4 = std::atoi(gridId.substr(3, 4).c_str());
        int m5 = std::atoi(gridId.substr(4, 5).c_str());
        int m6 = std::atoi(gridId.substr(5, 6).c_str());
        int m7 = std::atoi(gridId.substr(6, 7).c_str());
        int m8 = std::atoi(gridId.substr(7, 8).c_str());
