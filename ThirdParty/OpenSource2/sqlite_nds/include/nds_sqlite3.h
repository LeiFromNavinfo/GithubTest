...
**
** Generated on 2015-05-12 12:07:52 UTC from these sources:
**
** cc40d3787fcc64156eb611b677cd80ec447b2e75  mkdevkit.tcl
** 35c8b8baacb96d92abbb34a83a997b797075b342  nextchar.c
** 07dda7cd692911d2f22269953418d049f2e2c0ee  shell.c
** 713c587a057334de42c41ad9566f10e255d3ad27  spaceanal.tcl
** 25810dda37fc904b0772a13efd8ca072fb09e355  spellfix.c
** 451971601d3fea5dd5664e522c8b1addc844999c  sqlite3.c
** 1b4fd415129477bbc66c36138ddd6bc98f57f7ea  sqlite3.h
** 9111a95999edac92229c972e2c34fbc171bbb6c5  tclsqlite.c
** 870124b95ec4c645d4eb84f15efb7133528fb1a5  test_intarray.c
** 9dc57417fb65bc7835cc18548852cc08cc062202  test_intarray.h
** 9fefd23f6cc3fa9bf0748a5e453167e7b9f193ce  test_multiplex.c
** c08e4e8f8651f0c5e0509b138ff4d5b43ed1f5d3  test_multiplex.h
** cb3ab9569788160d4e9eb4f2db22610cd66f928d  zipvfs.c
** 5ef64b1ecac2029ca0af52e871171ef146063bce  zipvfs.h
*/
#ifndef _NDS_SQLITE_H
#define _NDS_SQLITE_H 1
#ifndef NDS_LONG_AND_LARGE_FILES
  #define SQLITE_ENABLE_8_3_NAMES 2
#endif
#define SQLITE_USE_URI 1
/*
** The SQLITE_NDSEV_DEVKIT_VERSION includes the manually set version number,
** the date when the source files were first assemblied into the devkit, and
** a prefix from the SHA1 hash of the nds_sqlite3.c source file.  This is the
** version string thaat is shown on the command-line shell banner.  The
** SHA1 hash of nds_sqlite3.c is designed to make the version easier to
** located in the configuration management system.
*/
#define SQLITE_NDSEV_DEVKIT_VERSION "1.5.20 2015-05-12 12:07:52 83a8c15ccfea0c27"
/*
** The DEVKIT and DEVKIT_ID are derived from a SHA1 hash of the source
** files listed above.  The value of SQLITE_NDSEV_DEVKIT_ID is returned
** by the nds_source_id() function.  In order to verify that the same
** version of nds_sqlite3.h and nds_sqlite3.c were used in the build,
** applications should include code logically equivalent to this:
**
**    assert( strcmp(SQLITE_NDSEV_DEVKIT_ID, nds_source_id())==0 );
**
*/
#define SQLITE_NDSEV_DEVKIT 0xc5c94076
#define SQLITE_NDSEV_DEVKIT_ID "c5c94076e42e5d5bf751dae72d030337afbfbcc6 1.5.20"
#ifndef SQLITE_API
# define SQLITE_API
#endif
#ifdef __cplusplus
extern "C" {
  SQLITE_API const char *nds_source_id(void);
}
#else
SQLITE_API const char *nds_source_id(void);
#endif
...
#define SQLITE_SOURCE_ID      "2015-05-12 00:46:40 c223910e726131d7b718b556c83df5faa723369d"
